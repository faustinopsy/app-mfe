        ...
        users.forEach(user => {
            usersHtml += `
                <div class="collection">
                    <li class="collection-item"> ${user.usuario_id} - ${user.nome} - ${user.email} 
                    </li>
                    <div class="grupo"> 
                        <button class="btn waves-effect waves-light orange secondary-content update" data-id="${user.usuario_id}">Editar</button>
                    <button class="btn waves-effect waves-light red secondary-content delete" data-id="${user.usuario_id}">Deletar</button>
